        ...
        body: restState.isLoading
            ...
            : RefreshIndicator(
                ...
                child: CustomScrollView(
                  // UX Improvement: Dismiss keyboard instantly upon scrolling
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            // UX Improvement: Show "Search" action button on keyboard
                              ...
                              suffixIcon: _searchController.text.isNotEmpty
                                  ? IconButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        // Return focus to field after clearing
                                        FocusScope.of(context).unfocus();
                                      },
                                    )
                                  : null,
                      ...
                      child: SizedBox(
                        ...
                        child: ListView(
                          ...
                          children: [
                            _buildCategoryItem(
                              'Biryani',
                              'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?q=80&w=200',
                            ),
                            _buildCategoryItem(
                              'Burger',
                            ...
                            _buildCategoryItem(
                              'Desserts',
                              'https://images.unsplash.com/photo-1563805042-7684c019e1cb?q=80&w=200',
                            ),
                            _buildCategoryItem(
                              'North Indian',
                              'https://images.unsplash.com/photo-1565557623262-b51c2513a641?q=80&w=200',
                            ),
                          ],
                        ),
                      ),
                        ...
                        child: SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final restaurant =
                                  restState.allRestaurants[index];
                    ...
                    restState.filteredRestaurants.isEmpty
                        ...
                        : SliverList(
                            delegate: SliverChildBuilderDelegate(
                              (context, index) {
                                final restaurant =
                                    restState.filteredRestaurants[index];
                                return RestaurantCard(
                                  ...
                                  onTap: () {
                                    ...
                                    context.push(
                                      AppRoutes.menuPath(restaurant.id),
                                    );
                                  },
                                );
                              },
  ...
  Widget _buildCategoryItem(String title, String imageUrl) {
    return GestureDetector(
      onTap: () {
        ...
        // UX Improvement: Drop the keyboard if they tap a category while typing
        FocusScope.of(context).unfocus();
      },
      child: Container(
